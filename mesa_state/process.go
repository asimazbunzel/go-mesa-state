...
func (M *MESAEvolution) GetProcessInfo () {
  ...
  log.LogInfo("mesa_state/process.go (func GetProcessInfo)", "getting MESA process information")
...
func (M *MESAEvolution) getMESAProcessState () error {
  ...
  log.LogDebug("mesa_state/process.go (func getMESAProcessState)", "retrieving status of MESA process")
...
func (M *MESAEvolution) getMESAProcessExeDirectory () error {
  ...
  log.LogDebug("mesa_state/process.go (func getMESAProcessExeDirectory)", "retrieving directory where MESA executable is running")
...
func (M *MESAEvolution) getMESAProcessCWD () error {
  ...
  log.LogDebug("mesa_state/process.go (func getMESAProcessCWD)", "locating working directory of MESA process")
